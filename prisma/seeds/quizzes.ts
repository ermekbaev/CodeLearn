export interface Quiz {
  ...
  export const quizzes: Quiz[] = [
    // JavaScript курс квизы
    {
      ...
      explanation: 'JavaScript - это высокоуровневый язык программирования, который используется для создания динамических элементов на веб-страницах.'
    },
    {
      id: 'js-quiz-2',
      lessonId: '2',
      ...
      explanation: 'const используется для объявления переменных, значение которых не может быть изменено после первоначального присвоения.'
    },
    ...
    },
    {
      ...
      explanation: 'В Python нет встроенного типа данных "fixed". Существуют list, tuple, dictionary и другие.'
    },
    ...
    // HTML/CSS курс квизы
    {
      ...
      explanation: 'Тег <head> содержит метаданные, такие как title, meta-теги, подключаемые стили и скрипты.'
    },
    {
      id: 'html-quiz-2',
      lessonId: '8',
      ...
      explanation: 'В CSS для изменения цвета текста используется свойство color.'
    },
    ...
    // React курс квизы
    {
      ...
      explanation: 'JSX позволяет описывать структуру пользовательского интерфейса прямо в коде JavaScript'
    },
    {
      id: 'react-quiz-2',
      lessonId: '11',
      ...
      explanation: 'useState - основной хук для работы с локальным состоянием в функциональных компонентах React'
    }
  ];